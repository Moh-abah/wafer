...
import { WafirLogo } from "@/components/shared/WafirLogo"; // ✅ استيراد الشعار الجديد
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm space-y-6">
        ...
        >
          {/* ✅ التعديل 3 – استبدال الشعار القديم بمكوّن WafirLogo الجديد */}
          <WafirLogo  className="h-24 w-24" />
