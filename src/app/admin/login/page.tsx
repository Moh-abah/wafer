...
//       )}
//       style={{
//         background: "linear-gradient(135deg, #0A1628 0%, #0D1B2A 25%, #1B1040 50%, #0D1526 75%, #0A1628 100%)",
//         backgroundSize: "300% 300%",
//       }}
//     >
//       {/* Decorative background pattern */}
...
//       <motion.div
//         className="pointer-events-none absolute -top-20 left-1/4 h-72 w-72 rounded-full"
//         style={{ background: "radial-gradient(circle, rgba(255,42,122,0.2) 0%, transparent 70%)" }}
//         variants={floatVariants}
//         initial="initial"
//         animate="animate"
//         transition={{ duration: 2, delay: 0.2 }}
...
//       <motion.div
//         className="pointer-events-none absolute -bottom-32 right-1/4 h-80 w-80 rounded-full"
//         style={{ background: "radial-gradient(circle, rgba(0,194,184,0.15) 0%, transparent 70%)" }}
//         variants={floatVariants}
//         initial="initial"
//         animate="animate"
//         transition={{ duration: 2, delay: 0.5 }}
...
//         >
//           <div
//             className="h-24 w-24 drop-shadow-[0_0_24px_rgba(255,42,122,0.4)]"
//             style={{
//               maskImage: "url(/logowafir.png)",
//               maskSize: "contain",
//               maskRepeat: "no-repeat",
