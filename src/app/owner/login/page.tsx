...
function OwnerLoginForm() {
 ...
 return (
  <div
   ...
   style={{
    background: "linear-gradient(135deg, #071320 0%, #091825 20%, #082030 45%, #0D2137 65%, #0D1526 85%, #071320 100%)",
  ...
  >
   ...
   <motion.div
    ...
    style={{ background: "radial-gradient(circle, rgba(0,163,224,0.2) 0%, transparent 70%)" }}
   ...
   <motion.div
    ...
    style={{ background: "radial-gradient(circle, rgba(0,102,153,0.15) 0%, transparent 70%)" }}
    variants={floatVariants}
    initial="initial"
    animate="animate"
